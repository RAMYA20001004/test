...
const Portfolio=()=>{
   ...
   <div className="home-buttons d-flex flex-wrap justify-content-start">
    ...
    <a href="https://www.linkedin.com/in/nikhil-pusala-03b714227/" target="_blank"><i className="fa-brands fa-linkedin-in home-icons"></i></a>
    ...
    <div className="container">
        ...
        <div className="contact-section col-md-12 col-12">
            ...
            <span className="pl-3" >
                <h3>LinkedIn</h3>
                <a  className="contact-linkedIn" href="https://www.linkedin.com/in/nikhil-pusala-03b714227/" target="_blank">https://www.linkedin.com/in/Nikhil Pusala</a>
                    </span>
